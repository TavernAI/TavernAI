    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if (data.result != 'file not find') {
                ...
                $("#settings_perset").append('<option value="gui">GUI KoboldAI Settings</option>');  //RossAscends: adding in the GUI settings, since it is not loaded dynamically
                ...
                $('#temp_novel_counter').html(temp_novel + addZeros);

                addZeros = "";
                if (isInt(rep_pen_novel)) addZeros = ".00";
                $('#rep_pen_novel').val(rep_pen_novel);
                $('#rep_pen_novel_counter').html(rep_pen_novel + addZeros);
                $('#rep_pen_size_novel').val(rep_pen_size_novel);
                $('#rep_pen_size_novel_counter').html(rep_pen_size_novel + " Tokens");
