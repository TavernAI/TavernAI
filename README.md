...
| :-- | :-- | :-- |
| Windows 10 / 11 | Portable `.zip`, x64 (139 MB) | **[Download v2.5.0](https://github.com/TavernAI/TavernAI/releases/download/v2.5.0/TavernAI-v2.5.0-win-x64.zip)** |
| Linux | Portable `.tar.gz`, x64 (142 MB) | **[Download v2.5.0](https://github.com/TavernAI/TavernAI/releases/download/v2.5.0/TavernAI-v2.5.0-linux-x64.tar.gz)** |
