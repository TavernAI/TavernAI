...
- [Windows 10, 11](https://github.com/TavernAI/TavernAI/releases/download/v2.2.3/TavernAI-v2.2.3-standard-win-x64.zip)
- [Linux](https://github.com/TavernAI/TavernAI/releases/download/v2.2.3/TavernAI-v2.2.3-standard-linux-x64.tar.gz)
...
- Run local LLM and VLM models: CPU, CUDA, and Vulkan backends
...
The app does not make background network requests - no auto update checks, no load remote frameworks, fonts or other external assets.
